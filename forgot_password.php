...
<head>
	<title>Ip Telephony - Forgot Password</title>
	...
	<link rel="stylesheet" type="text/css" media="all" href="css/forgot_password.css" />
...
<div class="wrapper">
	...
	<div class="sidebar">
		...
		<ul>
			<li>
				<a id="btnlogin" title="Login">
					<span class="icon"><i class="fas fa-home"></i></span>
					<span class="item">Login</span>
				</a>
			</li> 
			<li>
				<a id="btnforgot_password" title="Forgot Password" class="active">
					<span class="icon"><i class="fas fa-home"></i></span>
					<span class="item">Forgot Password</span>
				</a>
			</li>
			<li>
				<a id="btnsearch" title="Search">
					<span class="icon"><i class="fas fa-home"></i></span>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="email" id="txtemail" name="txtemail" placeholder="Email" class="form-control" required placeholder="Email" title="Email" />
						<p id="txtemail_error" class="error"></p>
					</div>

				</div> 
				<div class="modal-footer"> 
					<button id="btn_forgot_password" type="button" class="btn btn-success" title="Get Password">Get Password</button>
				</div>
			</div>
	...
	<script src="js/forgot_password.js" type="text/javascript" language="javascript" defer></script>
