...
<div class="wrapper">
	...
	<div class="sidebar">
		...
		<ul>
			<li>
				<a id="btnlogin" title="Login" class="active">
					<span class="icon"><i class="fas fa-home"></i></span>
					<span class="item">Login</span>
				</a>
			</li> 
			<li>
				<a id="btnforgot_password" title="Forgot Password">
					<span class="icon"><i class="fas fa-home"></i></span>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="password" id="txtpassword" name="txtpassword" placeholder="Password" class="form-control" required placeholder="Password" title="Forgot Password" />
						<p id="txtpassword_error" class="error"></p>
					</div>

				</div> 
				<div class="modal-footer"> 
					<button id="btn_login" type="button" class="btn btn-success" title="Login">Login</button>
				</div>
			</div>
