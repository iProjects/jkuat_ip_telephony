...
if (isset($_COOKIE['loggedinuser']))
{
	...
	if (isset($_COOKIE["origin"])) {
		...
		echo $global_path; 
		header('Location: ' . $global_path . 'departments.php');
		exit(); 
	}
}else{ 
		$global_path = $_COOKIE["origin"];
...
<head>
	<title>Ip Telephony - Departments</title>
	...
	<link rel="stylesheet" type="text/css" media="all" href="css/department.css" /> 
...
<body>
		...
		<div class="sidebar">
			...
			<ul>
				...
				<li id="view_departments">
					<a id="btnlist_departments" class="active">
	...
	<div id="dashboard_container">
		...
		<div id="department_container">
			<div id="div_container"> 
				<button id="btncreate_department_view" type="button" class="btn btn-success btn_create">Create Department</button>	 
			</div>
			
			<div id="div_admin_search_container">
				   
				<div class="div_search">
					<label for="txt_search_campus">Campus</label> 
					<input type="text" id="txt_search_campus" name="txt_search_campus" placeholder="Name" class="form-control" required placeholder="Name" />
				</div>
		...
		<div id="div_edit_department_container">
	...
	<!-- create Modal -->
	<div class="modal fade crud_modal" id="create_department_modal" tabindex="-1" role="dialog" aria-labelledby="create_department_modal_label">
		<div class="modal-dialog" role="document">
		
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="create_department_modal_label">Create Department</h4>
				</div>
				...
				<div class="modal-footer"> 
					<button id="btncreate_department" type="button" class="btn btn-success" ><img src="images/add.png" alt="Create" title="Create" style="vertical-align:bottom;" />Create</button>
					<button id="btnclose_create_department_modal" type="button" class="btn btn-danger" data-dismiss="modal"><img src="images/cancel.png" alt="Cancel" title="Cancel" style="vertical-align:bottom;" />Cancel</button>
				</div>
			</div>
	...
	<!-- edit Modal -->
	<div class="modal fade crud_modal" id="edit_department_modal" tabindex="-1" role="dialog" aria-labelledby="edit_department_modal_label">
		<div class="modal-dialog" role="document">
		
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="edit_department_modal_label">Edit Department</h4>
				</div>
				...
				<div class="modal-footer"> 
					<button id="btnupdate_department" type="button" class="btn btn-success" ><img src="images/add.png" alt="Update" title="Update" style="vertical-align:bottom;" />Update</button>
					<button id="btnclose_edit_department_modal" type="button" class="btn btn-danger" data-dismiss="modal"><img src="images/cancel.png" alt="Cancel" title="Cancel" style="vertical-align:bottom;" />Cancel</button>
				</div>
			</div>
	...
	<script src="js/department.js" type="text/javascript" language="javascript" defer></script>
