...
<body>
	...
	<div id="maincontainer" class="container">
		<div id="div_container">
			...
			<button id="btncreate_department_view" type="button" class="btn btn-success crud_buttons"><img src="images/add.png" alt="Create" title="Create" style="vertical-align:bottom;" />create department</button>
