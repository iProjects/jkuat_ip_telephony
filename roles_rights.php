...
if (isset($_COOKIE['loggedinuser']))
{
	...
	if (isset($_COOKIE["origin"])) {
		...
		echo $global_path; 
		header('Location: ' . $global_path . 'roles_rights.php');
		exit(); 
	}
}else{ 
		$global_path = $_COOKIE["origin"];
...
<head>
	<title>Ip Telephony - Roles Rights</title>
	...
	<link rel="stylesheet" type="text/css" media="all" href="css/role_right.css" /> 
...
<body>
		...
		<div class="sidebar">
			...
			<ul>
				...
				<li id="view_roles_rights">
					<a id="btnlist_roles_rights" class="active">
						<span class="icon"><i class="fas fa-tachometer-alt"></i></span>
	...
	<div id="dashboard_container">
		...
		<div id="role_container">
			<div id="div_container"> 
				<button id="btncreate_role_right_view" type="button" class="btn btn-success btn_create">Create Role Right</button>	 
			</div>
			...
			<div id="div_admin_search_container">
				...
				<div class="div_search">
					<label for="txt_search_right_name">Right Name</label> 
					<input type="text" id="txt_search_right_name" name="txt_search_right_name" placeholder="Right Name" class="form-control" required placeholder="Right Name" />
				</div>
		...
		<div id="div_edit_role_right_container">
	...
	<!-- create Modal -->
	<div class="modal fade crud_modal" id="create_role_right_modal" tabindex="-1" role="dialog" aria-labelledby="create_role_right_modal_label">
		<div class="modal-dialog" role="document">
		
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="loginmodallabel">Create Role Right</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="cbo_create_right">Right<span class="text-danger">*</span></label> 
				...
				<div class="modal-footer"> 
					<button id="btncreate_role_right" type="button" class="btn btn-success" ><img src="images/add.png" alt="Create" title="Create" style="vertical-align:bottom;" />Create</button>
					<button id="btnclose_create_role_right_modal" type="button" class="btn btn-danger" data-dismiss="modal"><img src="images/cancel.png" alt="Cancel" title="Cancel" style="vertical-align:bottom;" />Cancel</button>
				</div>
			</div>
	...
	<!-- edit Modal -->
	<div class="modal fade crud_modal" id="edit_role_right_modal" tabindex="-1" role="dialog" aria-labelledby="edit_role_right_modal_label">
		<div class="modal-dialog" role="document">
		
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="edit_role_right_modal_label">Edit Role Right</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="cbo_edit_right">Right<span class="text-danger">*</span></label> 
				...
				<div class="modal-footer"> 
					...
					<button id="btnclose_edit_role_right_modal" type="button" class="btn btn-danger" data-dismiss="modal"><img src="images/cancel.png" alt="Cancel" title="Cancel" style="vertical-align:bottom;" />Cancel</button>
				</div>
			</div>
	...
	<script src="js/role_right.js" type="text/javascript" language="javascript" defer></script>
