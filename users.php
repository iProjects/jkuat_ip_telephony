	...
	<div id="dashboard_container">
		...
		<div id="user_container">
			...
			<div id="div_admin_search_container">
				...
				<div class="div_search">
					<label for="txt_search_full_names">Full Name</label> 
					<input type="text" id="txt_search_full_names" name="txt_search_full_names" placeholder="Full Name" class="form-control" required placeholder="Full Name" />
				</div>
