...
<head>
	<title>Ip Telephony - Roles</title>
	...
	<link rel="stylesheet" type="text/css" media="all" href="css/role.css" /> 
...
<body>
	...
	<div class="wrapper">
		...
		<div class="sidebar">
			...
			<ul>
				...
				<li id="view_roles">
					<a id="btnlist_roles" class="active">
						<span class="icon"><i class="fas fa-tachometer-alt"></i></span>
	...
	<div id="dashboard_container">
		...
		<div id="role_container">
			<div id="div_container"> 
				<button id="btncreate_role_view" type="button" class="btn btn-success btn_create">Create Role</button>	 
			</div>
		...
		<div id="div_edit_role_container">
	...
	<!-- create Modal -->
	<div class="modal fade crud_modal" id="create_role_modal" tabindex="-1" role="dialog" aria-labelledby="create_role_modal_label">
		<div class="modal-dialog" role="document">
		
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="create_role_modal_label">Create Role</h4>
				</div>
				...
				<div class="modal-footer"> 
					<button id="btncreate_role" type="button" class="btn btn-success" ><img src="images/add.png" alt="Create" title="Create" style="vertical-align:bottom;" />Create</button>
					<button id="btnclose_create_role_modal" type="button" class="btn btn-danger" data-dismiss="modal"><img src="images/cancel.png" alt="Cancel" title="Cancel" style="vertical-align:bottom;" />Cancel</button>
				</div>
			</div>
	...
	<!-- edit Modal -->
	<div class="modal fade crud_modal" id="edit_role_modal" tabindex="-1" role="dialog" aria-labelledby="edit_role_modal_label">
		<div class="modal-dialog" role="document">
		
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="edit_role_modal_label">Edit Role</h4>
				</div>
				...
				<div class="modal-footer"> 
					<button id="btnupdate_role" type="button" class="btn btn-success" ><img src="images/add.png" alt="Update" title="Update" style="vertical-align:bottom;" />Update</button>
					<button id="btnclose_edit_role_modal" type="button" class="btn btn-danger" data-dismiss="modal"><img src="images/cancel.png" alt="Cancel" title="Cancel" style="vertical-align:bottom;" />Cancel</button>
				</div>
			</div>
	...
	<script src="js/role.js" type="text/javascript" language="javascript" defer></script>
