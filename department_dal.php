...
class department_dal
{
	...
	public function create_department($department_name, $addedby)
    {
		try{
			...
			$response = "<div class='alert alert-success'>Department [ " . $department_name . " ] was successfully created. <br /> Last Insert Id = [ " . $lastInsertId . " ]</div>";
			return $response;
    ...
    public function update_department($department_name, $id)
    {
		try{
			...
			$response = "<div class='alert alert-success'>Department [ " . $department_name . " ] was successfully updated.</div>";
    ...
    public function delete_department($id)
    {
		try{
			...
			$response = "<div class='alert alert-success'>Department [ " . $department_name . " ] was successfully deleted.</div>";
			return $response;
	...
	public function search_departments_v2($page, $records_to_display, $department_name)
	{	 	
		// PAGINATION VARIABLES
		// page is the current page, if there's nothing set, default is page 1
		//$page = isset($_POST['page']) ? $_POST['page'] : 1;
		...
		*/
		...
		if(!empty($department_name))
		{
			...
			$count_query = "SELECT * FROM departments WHERE department_name LIKE :department_name ORDER BY department_name ASC";
		...
		{				
			...
			$count_query = "SELECT * FROM departments ORDER BY id DESC";
